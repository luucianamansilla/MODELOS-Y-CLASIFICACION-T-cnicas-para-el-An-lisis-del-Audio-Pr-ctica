...
#%%
# Cargar audio y mostrar informacion (Punto 4 de la practica)
...
#%%
# Imprimir la senal sonora (Punto 5 de la practica)
...
#%%
# Reproducir senal original (Punto 6 de la practica)
print("Reproduciendo: Senal original")
Audio(audio, rate=sr)

#%%
# Modificar frecuencia de muestreo (Punto 7 de la practica)
...
#%%
# Bajar calidad del audio (Punto 8 de la practica)
